<div
    ...
    class="w-full max-w-5xl mx-auto space-y-6 py-4"
>
    {{-- Toggle button --}}
    ...
    {{-- Slide content --}}
    <div x-show="!showDemo" x-transition:enter.duration.300ms x-transition:leave.duration.200ms class="space-y-6">
